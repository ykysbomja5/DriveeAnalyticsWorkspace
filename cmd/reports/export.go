...
// exportPayload объединяет данные, нужные окружающему рабочему процессу.
...
// writeExport сериализует подготовленные данные в нужный формат ответа.
...
// buildPDF строит производный результат из intent или данных сервиса.
...
// writePDFSection сериализует подготовленные данные в нужный формат ответа.
...
// renderPDFTable сериализует подготовленные данные в нужный формат ответа.
...
// buildDOCX строит производный результат из intent или данных сервиса.
...
// documentXML выполняет отдельный шаг окружающего сервисного сценария.
...
// docTableXML выполняет отдельный шаг окружающего сервисного сценария.
...
// docTableCellXML выполняет отдельный шаг окружающего сервисного сценария.
...
// writeDocParagraph сериализует подготовленные данные в нужный формат ответа.
...
// contentTypesXML выполняет отдельный шаг окружающего сервисного сценария.
...
// rootRelsXML выполняет отдельный шаг окружающего сервисного сценария.
...
// stylesXML выполняет отдельный шаг окружающего сервисного сценария.
...
// exportHighlights выполняет отдельный шаг окружающего сервисного сценария.
...
// safeDownloadName выполняет отдельный шаг окружающего сервисного сценария.
...
// findWindowsFonts выполняет отдельный шаг окружающего сервисного сценария.
...
// xmlEscape выполняет отдельный шаг окружающего сервисного сценария.
